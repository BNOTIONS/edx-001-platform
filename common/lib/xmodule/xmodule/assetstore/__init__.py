...
class AssetMetadata(object):
    ...
    @contract(asset_id='AssetKey', basename='basestring | None', internal_name='str | None', locked='bool | None',
              contenttype='basestring | None', thumbnail='str|None',
              fields='dict | None', curr_version='str | None', prev_version='str | None', edited_by='int | None', edited_on='datetime | None')
    def __init__(self, asset_id,
        ...
        Arguments:
            ...
            field_decorator (function): used by strip_key to convert OpaqueKeys to the app's understanding.
                Not saved.
            kwargs: used to add arbitrary fields to the metadata
        """
